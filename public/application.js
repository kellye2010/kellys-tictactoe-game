...
/***/ function(module, exports, __webpack_require__) {
	...
	var onGetGame = function onGetGame(event) {
	  ...
	  event.preventDefault();
	  api.getGame(data).then(ui.getGameSuccess).catch(ui.getGameFailure);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var getGamesSuccess = function getGamesSuccess(data) {
	  $('#messages').text('You have played ' + data.games.length + ' games and ' + data.games[data.games.length - 1].id + ' was your last game ID');
	};
